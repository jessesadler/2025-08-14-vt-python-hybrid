...
venue: "Virginia Tech"        # brief name of the institution that hosts the workshop without address
address: "Hybrid: University Mall 2104, Blacksburg Virginia and Online"
country: "us"      # lowercase two-letter ISO country code such as "fr"
language: "en"     # lowercase two-letter ISO language code such as "fr"
latitude: "37.2343"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-80.4344"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "Ausgut 14 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 4:30 pm EDT"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2025-08-14      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2025-08-14        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Mariam Ismail", "Nathaniel Porter"] # boxed, comma-separated list of instructors' names as strings
helper: ["James Tuttle", "Bipasha Banerjee", "Chris Kuhlman"]     # boxed, comma-separated list of helpers' names
email: ["jrsadler@vt.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor
